...
### Download Location
**Version 1** of the Trust Store Management Script can be downloaded from this [link](Trust_Store_Mangagement_Script_V1.zip).
...
The sample output file created in the example above is found [here](sample-tsmt-output.p7b).

#### Sample Output - macOS
[TO-DO] - Capture macOS output.

The sample output file created in the example above is found [here](sample-tsmt-output.mobileconfig).
